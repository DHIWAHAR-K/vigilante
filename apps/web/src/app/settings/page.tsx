          ...
          <div className="flex flex-col gap-4">
            <div className="p-6 rounded-xl border border-border-subtle bg-bg-surface flex flex-col gap-2 relative overflow-hidden group">
              ...
              <div className="flex justify-between items-center w-full">
                ...
                <span className="text-mono-xs text-success bg-success-subtle px-2 py-0.5 rounded-md">Connected</span>
              </div>
              <p className="text-caption text-text-secondary">http://localhost:11434</p>
            </div>
          </div>
        </section>
